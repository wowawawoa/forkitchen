...
const cabinetTypesItems = [
    { id: 1, info: "<strong>Stock Cabinets:</strong> Stock cabinets come in various standard sizes; usually timber constructions with melamine shell over it. They are a readily available and affordable option." },
    { id: 2, info: "<strong>Semi-Custom Cabinets:</strong> Semi-custom cabinets are constructed from a standard range but can be modified to suit the kitchen layout." },
    { id: 3, info: "<strong>Custom Cabinets:</strong> For Kitchen can build custom cabinets to fit your kitchen; you can select from an array of materials for cabinet shell." },
]

const cabinetMaterialsItems = [
    { id: 1, info: "<strong>Low-Pressure Laminate</strong> is easy to clean and available in diverse patterns and colors. Some examples are Laminex and Wilson-Art." },
    { id: 2, info: "<strong>High-Pressure Laminate</strong> comes in a wide variety of patterns, colours, and finishes including gloss, satin and metallic. Some examples are particleboard or MDF (Medium Density Fibreboard)." },
    { id: 3, info: "<strong>Polyurethane Painted</strong> often comes with layers worked into the surface." },
    { id: 4, info: "<strong>Solid Timber</strong> can be used as a structural or shell material, typically clear coated to get a natural finish." },
    { id: 5, info: "<strong>Timber Veneers</strong> are effortless to clean and create a graceful look." },
    { id: 6, info: "<strong>Vinyl Film</strong> is vacuum-sealed and is a newer option." },
]

const cabinetryFitOutItems = [
    { id: 1, info: "<strong>Shelving:</strong> Use open shelving for handy access for frequently used items; a walk-in island bench or a walk-in pantry preferably on lockable wheels for easy movement." },
    { id: 2, info: "<strong>Cabinet Corner:</strong> A cabinet corner unfolds a distinctive problem for access that's normally resolved by installing a bi-fold door. A revolving 'lazy Susan' in a corner cabinet can enhance access." },
    { id: 3, info: "<strong>Drawers:</strong> Installing pull-out drawers with good quality, easy-glide runners inside cupboards is a great way to store things effortlessly." },
]
        ...
        <ContentContainer>
            ...
            <DetailedInfoContainer>
                <DetailedInfoListContainer>
                    ...
                    <p>
                        As Adelaide's prominent kitchen designers for constructing all types
                        of kitchens, we specialize in designing readymade and custom
                    ...
                    <DetailedInfoList>
                        {cabinetMaterialsItems.map((cabinetMaterialsItem) => (
                            <KDetailedInfoListItem key={cabinetMaterialsItem.id}>
                                ...
                                <p
                                    dangerouslySetInnerHTML={{ __html: cabinetMaterialsItem.info }}
                                ></p>
                            </KDetailedInfoListItem>
                        ))}
                    </DetailedInfoList>
            ...
            <DetailedInfoContainer>
                ...
                <DetailedInfoListContainer>
                    ...
                    <p>The laminate benchtop is for the budget conscious and they are available in a variety of colours, designs, and styles offering complete value for your money. They are easy to maintain, durable, very affordable, and give a feel of the stylish stone benchtop.</p>
                    <h4>Stone Benchtops</h4>
                    <p>Stone stone benchtop come in diverse material choices including marble, granite, and engineered stone. You can choose the stone benchtop depending on your preferences and budget. Stone benchtops are tough, long-lasting and easy to maintain, and provides a plush look. Besides, they render a natural feel and can become a statement piece in your kitchen.</p>
                    <p>Readymade benchtops are available in standards sizes; however, you can get custom benchtops made as per your unique requirements.</p>
                </DetailedInfoListContainer>
            </DetailedInfoContainer>
            <DetailedInfoContainer>
                <DetailedInfoListContainer>
                    <h3>Kitchen Splashbacks Selection</h3>
                    <p>Kitchen splashbacks come in a wide range of material selections including:</p>
                    <h4>Glass Splashback:</h4>
                    <p>Glass is easy to clean and available in diverse prints and colour shades. Mirror glass opens up space by bouncing light and reflections around the room.</p>
                    <h4>Acrylic Splashback:</h4>
                    <p>Acrylic looks like glass but is a more cost-effective option.</p>
                    <h4>Tile Splashback:</h4>
                    <p>Tiles are available in a huge range of designs, patterns, colour shades, and material choices. In the past, tiles were widely used material and they are now seeing a big comeback.</p>
                    <h4>Stone Splashback:</h4>
                    <p>Stone creates a permanent, graceful, and rich look in the kitchen. If you select a stone for your splashback, it is advisable to install both your benchtop and splashback at the same time, so both can be made from the same batch of stone and avoid any colour differences.</p>
                    <h4>Stainless Steel Splashback:</h4>
                    <p>Stainless Steel provides an industrial feel to a kitchen, it's durable and hygienic.</p>
            ...
            <DetailedInfoContainer>
                ...
                <DetailedInfoListContainer>
                    ...
                    <p>At For Kitchen, we can optimise your kitchen space by arranging your kitchen appliances including your cooktop, microwave, refrigerator, or any other kitchen appliances. Everything will be in perfect order and you'll get a neat and spacious kitchen.</p>
                    <h3>Selecting Sinks & Taps</h3>
                    <p>Depending on the type of benchtop installed and available space, the material of the sink and its configuration (i.e. one or two bowls) are selected. Sinks can be installed on the benchtop using three different methods:</p>
                    <DetailedInfoList>
